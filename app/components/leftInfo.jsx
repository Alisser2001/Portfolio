...
export default function LeftInfo() {
    return (
        <section className="hidden md:flex flex-col justify-end items-start w-1/4 fixed right-3/4 pl-16 z-50 mt-24 animate-fade-1 opacity-0" style={{ height: "90%", animationDelay: "1s" }}>
