...
export default function Description({ idx, obj }) {
    return (
        <div key={idx + 30} className="flex flex-col justify-center items-start w-full h-auto animate-fade-1 opacity-0">
            ...
            <ul className="flex flex-col w-full 2xl:w-[90%] h-auto text-lg font-semibold">
                {obj.responsibilities.map((obj2, idx2) => {
                    return (
                        <p key={idx2 + 40} className='flex flex-row w-full h-auto justify-start items-start text-xl font-bold mb-8'>
