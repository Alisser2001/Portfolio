        ...
        <section className='flex flex-col w-1/2 h-screen justify-center items-start text-white' id='experience'>
            ...
            <div className="flex flex-row justify-between items-start w-full h-auto">
                <ul className="flex flex-col justify-center items-center h-auto border-l-2 border-l-[#2E28A0]" style={{width: "30%"}}>
                    <li value="tbg" onClick={(e) => handleActualJob(e)} className={`flex flex-row w-full h-auto py-3 px-5 font-bold text-lg cursor-pointer hover:bg-[#2E28A0] hover:bg-opacity-30 ${actualJob === "tbg" ? "border-l-4 border-l-[#2E28A0]" : ""}`}>TripBoysGang</li>
                    <li value="siu" onClick={(e) => handleActualJob(e)} className={`flex flex-row w-full h-auto py-3 px-5 font-bold text-lg cursor-pointer hover:bg-[#2E28A0] hover:bg-opacity-30 ${actualJob === "siu" ? "border-l-4 border-l-[#2E28A0]" : ""}`}>SIU</li>
                    <li value="inverjara" onClick={(e) => handleActualJob(e)} className={`flex flex-row w-full h-auto py-3 px-5 font-bold text-lg cursor-pointer hover:bg-[#2E28A0] hover:bg-opacity-30 ${actualJob === "inverjara" ? "border-l-4 border-l-[#2E28A0]" : ""}`}>InverJara</li>
                    <li value="sena" onClick={(e) => handleActualJob(e)} className={`flex flex-row w-full h-auto py-3 px-5 font-bold text-lg cursor-pointer hover:bg-[#2E28A0] hover:bg-opacity-30 ${actualJob === "sena" ? "border-l-4 border-l-[#2E28A0]" : ""}`}>SENA</li>
                    <li value="66" onClick={(e) => handleActualJob(e)} className={`flex flex-row w-full h-auto py-3 px-5 font-bold text-lg cursor-pointer hover:bg-[#2E28A0] hover:bg-opacity-30 ${actualJob === "66" ? "border-l-4 border-l-[#2E28A0]" : ""}`}>Technical Service 66</li>
                </ul>
